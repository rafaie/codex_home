---
name: session-start
description: Start a work session by summarizing repo state and proposing the top next features.
---
...
6) Recommend the next skill to run (usually `qa-intake` or `feature-kickoff`).
