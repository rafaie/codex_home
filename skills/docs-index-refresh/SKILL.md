...
description: Maintain docs/index.md as a living navigation hub that evolves feature-by-feature.
---

1) Read `docs/index.md` (if present), `docs/brief.md`, `spec/backlog.md`, and recent feature specs.
2) Update/create `docs/index.md` to include:
...
4) End by listing what changed in `docs/index.md`.
